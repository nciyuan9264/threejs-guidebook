function init() {
  ...
  let camera = initCamera(new THREE.Vector3(50, 80, 90));
  ...
  let borderLeft = new Physijs.BoxMesh(new THREE.BoxGeometry(2, 6, 130), ground_material, 0);
  ...
  let borderRight = new Physijs.BoxMesh(new THREE.BoxGeometry(2, 6, 130), ground_material, 0);
  borderRight.position.x = 31;
  borderRight.position.y = 2;

  ground.add(borderRight);

  let borderBottom = new Physijs.BoxMesh(new THREE.BoxGeometry(64, 6, 2), ground_material, 0);
  borderBottom.position.z = 65;
  borderBottom.position.y = 2;
  ground.add(borderBottom);

  let borderTop = new Physijs.BoxMesh(new THREE.BoxGeometry(64, 6, 2), ground_material, 0);
  ...
  let controls = new function () {
    ...
    this.addSpheres = function () {
      ...
      for (let i = 0; i < 5; i++) {
        ...
        let sphere = new Physijs.SphereMesh(new THREE.SphereGeometry(2, 20), Physijs.createMaterial(new THREE.MeshStandardMaterial({ color: colorSphere }), controls.sphereFriction, controls.sphereRestitution));
